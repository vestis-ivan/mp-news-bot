...
Правила:
- Выбери 3-5 самых применимых идей, если кандидатов хватает.
...
- Хуки должны быть цепляющими, конкретными, в стиле TikTok/Reels, и звучать как первая фраза ролика.
- Каждый хук должен быть beauty-first: маска, сыворотка, крем, SPF, макияж, аромат, волосы, кожа, отёки, сухость, блеск, поры, стойкость.
- Не делай абстрактные хуки вроде "эта песня улучшила мой уход". Если идея про трендовый звук, хук всё равно должен цеплять beauty-проблемой/результатом.
- Примеры уровня: "ЭТА МАСКА СПАСЛА МОЮ КОЖУ ЗА НОЧЬ", "НЕ ПОКУПАЙ SPF, ПОКА НЕ ПРОВЕРИШЬ ЭТО", "ПОЛОВИНА СЫВОРОТОК НЕ РАБОТАЕТ ИЗ-ЗА ЭТОЙ ОШИБКИ".
